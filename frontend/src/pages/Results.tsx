    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white relative overflow-hidden">
      ...
      <main className="max-w-6xl mx-auto p-6">
        <Card className="mb-8">
          ...
          <CardContent className="p-6">
            <p className="text-gray-700">
              Based on the symptoms you've described, you appear to be
              experiencing a{" "}
              <span className="font-semibold">migraine headache</span> with
              accompanying symptoms of mild fever. This assessment is based on
              the pattern, duration, and intensity of your symptoms.
            </p>
          </CardContent>
        </Card>
        ...
        <Tabs defaultValue="treatment" className="mb-8">
              ...
              <div className="bg-blue-50 p-4 rounded-md">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Take 1 tablet every 6-8 hours as needed for pain, not
                    exceeding 3 tablets in 24 hours.
                  </p>
              ...
              <div>
                ...
                <div className="mt-2 space-y-3">
                  <div className="border-b pb-2">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Take 2 tablets every 6 hours as needed, not exceeding 8
                      tablets in 24 hours.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Take 1-2 tablets every 4-6 hours as needed, not exceeding
          ...
          <TabsContent value="remedies" className="rounded-md border p-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              ...
              <li>
                Lavender essential oil inhalation may help with migraine
                symptoms
              </li>
        ...
        <Card>
          ...
          <CardContent className="p-6">
            <p className="text-gray-700">
              This assessment is based on the symptoms you've shared and should
              not replace professional medical advice. If your symptoms worsen,
              persist for more than 72 hours, or if you experience severe pain,
              dizziness, confusion, or high fever, please consult a healthcare
